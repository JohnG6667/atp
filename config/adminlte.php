...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Crear nuevo Work',
            'route'  => 'admin.works.create',
            'icon' => 'fas fa-camera fa-fw',
        ],
        ['header' => 'OPCIONES DE PICTURES'],
        [
            'text' => 'Lista de Pictures',
            'route'  => 'admin.pictures.index',
            'icon' => 'fas fa-images fa-fw',
        ],
        [
            'text' => 'Crear nuevo Picture',
            'route'  => 'admin.pictures.create',
            'icon' => 'fas fa-image fa-fw',
        ],
        ['header' => 'OPCIONES DE TEAM'],
        [
        ...
        [
            'text' => 'Crear nuevo Skill',
            'route'  => 'admin.skills.create',
            'icon' => 'fas fa-palette fa-fw',
        ],
        ['header' => 'OPCIONES DE TESTIMONIALES'],
        [
            'text' => 'Lista de Testimoniales',
            'route'  => 'admin.testimonials.index',
            'icon' => 'fas fa-mug-hot fa-fw',
        ],
        [
            'text' => 'Crear nuevo Testimonial',
