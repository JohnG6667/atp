<div class="row">
    <div class="form-group col">
        ...
        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre de la picture']) !!}
...
<div class="row mb-3">
    <div class="col">
        <div class="image-wrapper">
            @isset($picture->image)
                <img id="picture"
                    src="{{Storage::url($picture->image->url)}}"
                    alt="">
            @else
                <img id="picture"
    ...
    <div class="col">
        <div class="form-group">
            {!! Form::label('file', 'Imagen que se mostrará en la Picture') !!}
