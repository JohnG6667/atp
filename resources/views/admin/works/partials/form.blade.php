<div class="row">
    <div class="form-group col">
        ...
        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre del autor']) !!}
    ...
    <div class="form-group col">
        ...
        {!! Form::text('type', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el tipo de obra']) !!}
...
<div class="row mb-3">
    <div class="col">
        <div class="image-wrapper">
            @isset($work->image)
                <img id="picture"
                    src="{{Storage::url($work->image->url)}}"
                    alt="">
            @else
                <img id="picture"
    ...
    <div class="col">
        <div class="form-group">
            {!! Form::label('file', 'Imagen que se mostrará en el Work') !!}
...
<div class="form-group col">
    ...
    {!! Form::text('facebook', null, [
        'class' => 'form-control',
        'placeholder' => 'Ingrese el link de facebook de la obra',
    ]) !!}
...
<div class="form-group col">
    ...
    {!! Form::text('instagram', null, [
        'class' => 'form-control',
        'placeholder' => 'Ingrese el link de instagram de la obra',
    ]) !!}
...
<div class="form-group col">
    ...
    {!! Form::text('pinterest', null, [
        'class' => 'form-control',
        'placeholder' => 'Ingrese el link de pinterest de la obra',
    ]) !!}
